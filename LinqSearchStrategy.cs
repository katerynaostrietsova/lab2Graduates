...
namespace lab2Graduates.Strategies
{
    public class LinqSearchStrategy : IXmlSearchStrategy
    {
            ...
            string? keyword)
        {
            ...
            var result = elements
                // спочатку перетворюємо кожен XElement у кортеж (Graduate + groupFromXml)
                ...
                // беремо назад тільки модель Graduate
                .Select(g => g.Graduate)
                .ToList();
        ...
        // Допоміжний метод: повертає і Graduate, і groupFromXml
